...
public class PlaceOrderRegister extends Base_ClassPoc {
	...
	public void the_user_add_products_to_cart() throws InterruptedException {
	...
	public void the_user_click_proceed_to_checkout() throws InterruptedException {
		click(d.getCheckout());
		sleep(5000);
	...
	public void the_user_verify_logged_in_as_username_at_top() throws InterruptedException {
		
Assert.assertTrue("Logged in as username",a.getLogged_username().getText().contains("satheshkumar"));
	sleep(5000);
	
	}
	
	@When("the user Click Proceed To Checkout button")
	public void the_user_click_proceed_to_checkout_button() throws InterruptedException  {
		sleep(5000);
